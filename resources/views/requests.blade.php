...
<div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="number" name="units" id="units" class="form-control" placeholder="عدد الوحدات" min="1" required>
            </div>

            <!-- Location input -->
            <div class="form-group mb-3">
                <label for="location">المكان</label>
                <input type="text" name="location" id="location" class="form-control" placeholder="المدينة أو المنطقة" required>
            </div>
